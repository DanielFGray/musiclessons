          ...
          <div className="max-w-xl px-4 mx-auto sm:px-6 lg:py-16 lg:max-w-none lg:mx-0 lg:px-0">
            <div className="mt-6">
              ...
              <div className="mt-6">
                <a
                  href="#"
                  className="inline-flex px-4 py-2 text-base font-medium text-white border border-transparent rounded-md shadow-sm bg-gradient-to-r from-secondBrand-600 to-brand-600 hover:from-secondBrand-700 hover:to-brand-700"
                >
                  Get started
                </a>
              </div>
              ...
              <blockquote>
                <div>
                  <p className="text-base text-gray-500">
                    ...
                    Sit orci risus aenean curabitur donec aliquet. Mi venenatis
                    in euismod ut.”
                  </p>
                </div>

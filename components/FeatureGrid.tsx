export default function FeatureGrid() {
  return (
    <div className="bg-gradient-to-r from-secondBrand-800 to-brand-700">
      <div className="max-w-4xl px-4 py-16 mx-auto sm:px-6 sm:pt-20 sm:pb-24 lg:max-w-7xl lg:pt-24 lg:px-8">
        <h2 className="text-3xl font-extrabold tracking-tight text-white">
          Inbox support built for efficiency
        </h2>
        <p className="max-w-3xl mt-4 text-lg text-secondBrand-200">
        ...
        <div className="mt-12 grid grid-cols-1 gap-x-6 gap-y-12 sm:grid-cols-2 lg:mt-16 lg:grid-cols-4 lg:gap-x-8 lg:gap-y-16">
          <div>
            ...
            <div className="mt-6">
              ...
              <p className="mt-2 text-base text-secondBrand-200">
